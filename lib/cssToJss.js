...
module.exports = function (options) {
  ...
  if (!options.dashes) styles = camelize(styles)
  return styles
}
...
function toJssRules(cssRules, options) {
  ...
  function addRule(rule, rules) {
    ...
    rule.declarations.forEach(function (decl) {
      style[decl.property] = stripUnit(decl.value)
    })
    rules[key] = style
  }
      ...
      case 'keyframes':
        ...
        rule.keyframes.forEach(function (keyframe) {
          ...
          keyframe.declarations.forEach(function (decl) {
            frameValue[decl.property] = stripUnit(decl.value)
          })
